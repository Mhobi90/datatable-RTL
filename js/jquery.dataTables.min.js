...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"الأولى",sLast:"الأخيرة",sNext:"التالي",sPrevious:"السابق"},sEmptyTable:"No data available in table",sInfo:"إظهار _START_ إلى _END_ من أصل _TOTAL_ مدخل",sInfoEmpty:"اظهار 0 إلى 0 من أصل 0 مدخل",sInfoFiltered:"(البحث في _MAX_ مدخل)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"عرض _MENU_ مدخلات",sLoadingRecords:"تحميل...",sProcessing:"معالجة...",sSearch:"بحث:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"لا توجد سجلات مطابقة"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,
